...
- Изменилось [тело всех уведомлений](/../docs/api/receiving/notifications-format/incoming-message/). В тело уведомления добавлено поле [chatName](/../docs/api/receiving/notifications-format/incoming-message/).
- Изменилось [тело всех уведомлений](/../docs/api/receiving/notifications-format/incoming-message/) при получении пересылаемых сообщений. В тело уведомления добавлены поля: "forwardingScore", "isForwarded".
