...
- [Отправленное сообщение через API](outgoing-message/OutgoingApiMessage.md)
- [Статус отправленного сообщения](outgoing-message/OutgoingMessageStatus.md)

## Выбор кнопок

- [Нажатие пользователя на обычную кнопку](selected-buttons/ButtonsResponseMessage.md)
- [Нажатие пользователя на шаблонную кнопку](selected-buttons/TemplateButtonsReplyMessage.md)
- [Нажатие пользователя на значение списка выбора](selected-buttons/ListResponseMessage.md)
