...
```
### Examples
You may see the full example at: [sendTextMessage.py](https://github.com/green-api/whatsapp-api-client-python/blob/master/examples/sendTextMessage.py)
...
```
result = restApi.sending.sendMessage('11001234567@c.us', 'Message text')
```
