...
- [Incoming message with an array of contacts](./receiving/notifications-format/incoming-message/ContactsArrayMessage.md)
...
- [Get chat message](./journals/GetMessage.md)
